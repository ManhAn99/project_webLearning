...
router
  .on('/dic', function () {
    document.getElementById('app').innerHTML = '<dic-container></dic-container>'
  })
  .resolve();

router
  .on('/listening', function () {
    document.getElementById('app').innerHTML = '<listening-container></listening-container>'
  })
  .resolve();
...
router
  .on('/speakContainer', function () {
    document.getElementById('app').innerHTML = '<speak-container></speak-container>'
  })
  .resolve();

router
  .on('/flashCard', function () {
    document.getElementById('app').innerHTML = '<flash-container></flash-container>'
  })
  .resolve();
